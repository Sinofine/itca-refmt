...
[structure theorem for Artin rings]\index{Artin ring!structure theorem} An Artin ring $A$ is uniquely (up to isomorphism) a finite direct product of Artin local rings.
\end{theorem}
