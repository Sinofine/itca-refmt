...
\usepackage{tikz-cd}
\setmathfont{Libertinus Math}[math-style=TeX]
\usepackage{fontspec}
% \usepackage{tinos}
...
has as its algebraic analogue the important process of {\itshape localizing} a ring at a prime
...
$\subset$ for {\itshape strict} inclusion. Thus $A\subset B$ means that $A$ is contained in $B$ and is not equal to $B$.
\mainmatter
