...
\begin{proof}
  ...
  \[
    n>0 \implies f^{n} \notin \mathfrak{a}.
  \]
  Then $\Sigma$ is not empty because $0 \in \Sigma$. As in \ref{thm:1.3} Zorn's lemma
...
\end{proposition}
\begin{proof}
  $\implies$: Suppose $1-x y$ is not a unit. By \ref{cor:1.5} it belongs to some maximal
...
simple \ref{prop:1.1}: there is a one-to-one correspondence between ideals of $f(A)$ and
